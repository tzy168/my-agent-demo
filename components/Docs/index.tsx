...
const answer = await ragChain.invoke({ input: "什么是 RAG？" });`}
          ...
          <p className="docs-text">
            在 <code className="docs-code">app/api/rag/route.ts</code> 中接收用户问题，调用上述 RAG 链，并以纯文本流形式返回结果，复用项目已有的 <code className="docs-code">lib/server/chat.ts</code> 与响应工具。
          </p>
        </section>
        ...
        <section className="docs-section">
          ...
          <ol className="docs-list">
            ...
            <li>参考 <code className="docs-code">components/Chat/index.tsx</code> 的流式请求逻辑，向 <code className="docs-code">/api/rag</code> 发起提问并实时渲染返回的 Markdown。</li>
        ...
        <section className="docs-section">
          ...
          <ul className="docs-ul">
            <li>向量持久化：将 MemoryVectorStore 替换为 Chroma、Pinecone 或 PostgreSQL + pgvector。</li>
